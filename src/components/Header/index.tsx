                      ...
                      {menuItem.path ? (
                        ...
                        <>
                          <button
                            ...
                            className="text-dark group-hover:text-[#3F7171] flex cursor-pointer items-center justify-between py-2 text-base lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 dark:text-white/70 dark:group-hover:text-white"
                          >
                            {menuItem.title}
                            <span className="pl-3">
                          ...
                          >
                            {menuItem.submenu?.map((submenuItem) => (
                              <Link
                                ...
                                key={submenuItem.id}
                                className="text-dark hover:text-[#3F7171] block rounded-sm py-2.5 text-sm lg:px-3 dark:text-white/70 dark:hover:text-white"
                              >
                                {submenuItem.title}
                              </Link>
                            ))}
